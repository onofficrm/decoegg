...
$site_config = array(
    'site_name'           => '한도폭발카',
    'site_desc'           => '개인회생·저신용 중고차 할부 전문상담',
    'company_name'        => '한도폭발카',
    'ceo_name'            => '대표자명',
    'business_no'         => '000-00-00000',
    'phone'               => '1800-4959',
    'kakao_url'           => 'https://open.kakao.com/o/seC75DCi',
    ...
    'seo_title'           => '개인회생중고차할부·저신용중고차할부 상담 | 한도폭발카',
    'seo_description'     => '개인회생, 저신용 중고차 할부 전문상담. 차량 구매예산부터 추가 필요자금까지 상담합니다.',
    'main_keyword'        => '개인회생중고차할부',
    'sub_keywords'        => '저신용중고차할부,중고차할부상담',
    'robots'              => 'index,follow',
    'consultation_text'   => '조건 확인 상담',
    'footer_desc'         => '신용점수가 아닌, 가능한 조건을 끝까지 확인합니다.',
